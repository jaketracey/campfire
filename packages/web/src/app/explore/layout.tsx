...
export const metadata = {
  title: 'Explore Companions | Campfire',
  description:
    'Browse curated AI companions ready to chat. Find your perfect match from diverse personalities, archetypes, and conversation styles.',
};
