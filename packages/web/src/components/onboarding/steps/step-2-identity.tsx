...
import { useOnboardingStore, type VoiceOption, type CompanionArchetype } from '@/stores/onboarding-store';
...
export function Step2Identity() {
  ...
  const handleSurpriseMe = async () => {
    ...
    try {
      ...
      const primaryArchetype = ARCHETYPES.find(a => a.id === generated.archetype) || ARCHETYPES[0];
      const secondaryArchetype = generated.secondaryArchetype
        ? ARCHETYPES.find(a => a.id === generated.secondaryArchetype) || null
        : null;

      // Select voice based on LLM-generated gender preference
      const voicesByGender = VOICES.filter(v => v.gender === generated.voiceGender);
        ...
        const companion = await createCompanion({
          ...
          spec: {
            ...
            personality: {
              ...
              traits: {
                warmth: generated.personality.warmth / 100,
                energy: generated.personality.energy / 100,
                playfulness: generated.personality.playfulness / 100,
                formality: generated.personality.formality / 100,
                assertiveness: generated.personality.assertiveness / 100,
                curiosity: generated.personality.curiosity / 100,
                empathy: generated.personality.empathy / 100,
                spontaneity: generated.personality.spontaneity / 100,
                optimism: generated.personality.optimism / 100,
                directness: generated.personality.directness / 100,
              },
            },
            voice: {
              provider: 'elevenlabs',
