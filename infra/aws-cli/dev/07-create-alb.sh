...
MARKETING_TG_ARN=$(get_or_create_tg "${RESOURCE_PREFIX}-marketing-tg" "3001" "/api/health" "marketing")
log "Marketing target group ready: ${MARKETING_TG_ARN}"
...
# Note: Marketing site would typically be on a different subdomain
# For now, the default action routes to web app
