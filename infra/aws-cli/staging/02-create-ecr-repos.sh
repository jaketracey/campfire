#!/bin/bash
# =============================================================================
# Campfire AWS Infrastructure - Create ECR Repositories (Staging)
# =============================================================================
# Creates ECR repositories for all service container images
# with production-like scanning and lifecycle policies
#
...
create_ecr_repo() {
    ...
    # Set lifecycle policy to clean up old images (production-like retention)
    aws ecr put-lifecycle-policy \
        ...
        --lifecycle-policy-text '{
            "rules": [
                ...
                {
                    "rulePriority": 2,
                    "description": "Keep last 15 staging images",
                    "selection": {
                        "tagStatus": "tagged",
                ...
                {
                    "rulePriority": 3,
                    "description": "Keep last 5 dev/feature images",
                    "selection": {
                        "tagStatus": "tagged",
...
echo "  - Tag immutability: Enabled (production-like)"
...
echo "  docker tag <image>:latest ${ECR_REGISTRY}/${ECR_GATEWAY_REPO}:staging-\$(git rev-parse --short HEAD)"
echo "  docker push ${ECR_REGISTRY}/${ECR_GATEWAY_REPO}:staging-\$(git rev-parse --short HEAD)"
echo ""
