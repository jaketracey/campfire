#!/bin/bash
# =============================================================================
# Campfire AWS Infrastructure - Create RDS PostgreSQL Instance (Staging)
# =============================================================================
# Creates RDS PostgreSQL instance with pgvector extension support
# with production-like settings (larger instance, longer retention)
#
...
aws rds create-db-subnet-group \
    ...
    --db-subnet-group-description "Subnet group for Campfire RDS instances (staging)" \
...
echo "  - Storage:           gp3 (encrypted)"
echo "  - Backup retention:  ${RDS_BACKUP_RETENTION} days"
echo "  - Performance Insights: Enabled"
echo "  - Deletion Protection: Enabled"
echo "  - CloudWatch Logs:   PostgreSQL, Upgrade"
echo "  - Auto minor upgrade: Enabled"
echo ""
